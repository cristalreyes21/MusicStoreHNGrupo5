...
import com.example.musicstorehngrupo5.Adapters.MessageAdapter;
import com.example.musicstorehngrupo5.Models.mensajeModel;
import com.example.musicstorehngrupo5.NetworkTasks.GruposNetworkTasks.enviarMensajeAsyncTask;
import com.example.musicstorehngrupo5.R;
import com.example.musicstorehngrupo5.Utilidades.Imagenes.FileUtils;
import com.example.musicstorehngrupo5.Utilidades.Imagenes.ImageDownloaderAsync;
import com.example.musicstorehngrupo5.Utilidades.Nombramiento.UniqueFileNameGenerator;
        ...
        if (isRecording) {
            try {
                ...
                voiceMessage = FileProvider.getUriForFile(
                        this,
                        "com.example.musicstorehngrupo5.fileprovider",
                        audioFile
                );
