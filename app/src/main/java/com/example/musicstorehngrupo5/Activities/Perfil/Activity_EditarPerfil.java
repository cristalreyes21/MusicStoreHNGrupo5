...
import com.example.musicstorehngrupo5.Activities.Auth.Activity_CambiarContrasena;
import com.example.musicstorehngrupo5.NetworkTasks.PerfilNetworkTasks.UpdateImagenPerfilAsyncTask;
...
import com.example.musicstorehngrupo5.Activities.Auth.activity_personalizada_huella;
...
public class Activity_EditarPerfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageRef = FirebaseStorage.getInstance().getReferenceFromUrl("gs://musicstorehngrupo5.appspot.com/imagenesEditarPerfil");
