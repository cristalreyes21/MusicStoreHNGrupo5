...
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.autor;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.duracion;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.fechaLanzamiento;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.genero;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.idFavorito;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.idPlayList;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.idUsuario;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirVideo.imagenPortadaBase64;
...
public class PersonalizadaMetadataVideo extends DialogFragment {
    ...
    public static PersonalizadaMetadataVideo newInstance(Context context, Uri videoUri) {
        PersonalizadaMetadataVideo fragment = new PersonalizadaMetadataVideo();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.PersonalizadaMetadataVideo, null);
    ...
    private void obtenerMetadataUser() {
        ...
        if (getActivity() instanceof SubirVideo) {
            ((SubirVideo) getActivity()).videoItems();
        }
    }
    ...
    public void subirAudioFirebase(){
        ...
        new SubirVideoAsyncTask(getContext(), autor_aux, idUsuario, videoBase64 , imagenPortadaBase64, idPlayList, idFavorito, nombreVideo_aux, genero_aux, duracion, fechaLanzamiento).execute();
    }
