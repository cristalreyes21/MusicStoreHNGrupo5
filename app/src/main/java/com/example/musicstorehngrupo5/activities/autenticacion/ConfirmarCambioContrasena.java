...
import static com.example.musicstorehngrupo5.activities.autenticacion.CambiarContrasena.CorreoUsuario;
import static com.example.musicstorehngrupo5.activities.autenticacion.CambiarContrasena.NuevoPassEncriptada;
import static com.example.musicstorehngrupo5.activities.autenticacion.CambiarContrasena.VerificationCodeNuevaContra;
...
import com.example.musicstorehngrupo5.PersonalizadoAdvertencia;
import com.example.musicstorehngrupo5.PersonalizadoConfirmacionCorrecta;
...
public class ConfirmarCambioContrasena extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ConfirmaCambioContrasena);
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent RegresarCambioContrasena = new Intent(ConfirmaCambioContrasena.this, com.example.MusicStoreHNGrupo5.activities.autenticacion.CambiarContrasena.class);
    ...
    public void mensajesPersonalizados(){
        ...
        if(inputVerificacion.getText().toString().isEmpty()){
            ...
            PersonalizadoAdvertencia dialogFragment = PersonalizadoAdvertencia.newInstance(textoAdvertencia);
