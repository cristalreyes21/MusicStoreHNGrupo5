...
import com.example.musicstorehngrupo5.activities.PantallaPrincipal.PantallaPrincipal;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtviewOlvidaPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent recuperarContra = new Intent(getApplicationContext(), RecuperarContrasena1.class);
        ...
        btnLoginHuella.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(txtLoginUsuario.getText().toString().equals("")){
                    ...
                    PersonalizadoAdvertencia dialogFragment = PersonalizadoAdvertencia.newInstance(textoLogin);
