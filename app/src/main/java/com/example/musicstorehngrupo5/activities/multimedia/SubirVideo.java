...
public class SubirVideo extends AppCompatActivity {
    ...
    public void subirVideoFirebase() throws IOException {
        ...
        new SubirVideoAsyncTask(SubirVideo.this,autor, idUsuario, videoBase64 , imagenPortadaBase64, idPlayList, idFavorito, nombreVideo, genero, duracion, fechaLanzamiento).execute();
    }
    ...
    public void extraerMetadata() throws IOException {
        ...
        try {
            ...
            if(contadorElementosV > 0 && contadorElementosV < 7){
               PersonalizadaMetadataVideo dialogFragment = PersonalizadaMetadataVideo.newInstance(this, videoUri);
