...
import com.example.musicstorehngrupo5.Adapters.VideoPersonalAdapter;
import com.example.musicstorehngrupo5.Models.videoItem;
import com.example.musicstorehngrupo5.NetworkTasks.GruposNetworkTasks.obtenerVideosPersonalesAsyncTask;
import com.example.musicstorehngrupo5.R;

import java.util.ArrayList;
import java.util.List;

public class VideoSeleccion extends AppCompatActivity implements VideoPersonalAdapter.OnVideoItemClickListener{
