...
import com.example.musicstorehngrupo5.Models.infoEditarPlayList;
import com.example.musicstorehngrupo5.NetworkTaksMulti.EditarPlayListAsyncTask;
import com.example.musicstorehngrupo5.NetworkTaksMulti.infoPlayListEditarAsyncTask;
import com.example.musicstorehngrupo5.R;
import com.example.musicstorehngrupo5.Utilidades.UI.ConfirmationDialog;
...
public class EditarPlayList extends AppCompatActivity implements infoPlayListEditarAsyncTask.DataFetchListener{
    ...
    private com.example.musicstorehngrupo5.Utilidades.Token.token token = new token(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.EditarPlayList);
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ConfirmationDialog.showConfirmationDialog(
                        EditarPlayList.this, // Replace with your activity or fragment context
                        "Confirmación",
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            if (ContextCompat.checkSelfPermission(EditarPlayList.this, android.Manifest.permission.READ_MEDIA_IMAGES) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(EditarPlayList.this, new String[]{android.Manifest.permission.READ_MEDIA_IMAGES}, REQUEST_CODE);
            } else {
            ...
            if (ContextCompat.checkSelfPermission(EditarPlayList.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(EditarPlayList.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CODE_EXTERNAL);
            } else {
                // Permission is granted, proceed to pick an image
                pickImage();
            }
    ...
    private void updatePlayList(){
        ...
        //llama el asynctask
        new EditarPlayListAsyncTask(EditarPlayList.this).execute(jsonData.toString());
    }
