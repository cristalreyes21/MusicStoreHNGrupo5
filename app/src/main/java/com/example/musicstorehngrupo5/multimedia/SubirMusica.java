...
import com.example.musicstorehngrupo5.NetworkTasks.Multimedia.BuscarAudioAsyncTask;
...
public class SubirMusica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.Subirmusica);
    ...
    public void subirAudioFirebase() throws IOException {
        ...
        new SubirMusicaAsyncTask(SubirMusica.this,artista, idUsuario, audioBase64 , imagenPortadaBase64, idPlayList, idFavorito, nombreCancion, album, genero).execute();
    }
    ...
    public void extraerMetadata() throws IOException {
        ...
        try {
            ...
            if(contadorElementos > 0 && contadorElementos < 5){
               PersonalizadaMetadata dialogFragment = PersonalizadaMetadata.newInstance(this, audioUri);
