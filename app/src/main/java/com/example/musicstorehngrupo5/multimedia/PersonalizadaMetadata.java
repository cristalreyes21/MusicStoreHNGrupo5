...
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.album;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.artista;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.audioBase64;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.genero;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.idFavorito;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.idPlayList;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.idUsuario;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.imagenPortadaBase64;
import static com.example.musicstorehngrupo5.Activities.Multimedia.Activity_SubirMusica.nombreCancion;
...
public class PersonalizadaMetadata extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.PersonalizadaMetadata, null);
    ...
    private void obtenerMetadataUser() {
        ...
        if (getActivity() instanceof SubirMusica) {
            ((SubirMusica) getActivity()).musicaItems();
        }
    }
    ...
    public void subirAudioFirebase(){
        ...
        new SubirMusicaAsyncTask(getContext(),artista_aux, idUsuario, audioBase64 , imagenPortadaBase64, idPlayList, idFavorito, nombreCancion_aux, album_aux, genero_aux).execute();
    }
